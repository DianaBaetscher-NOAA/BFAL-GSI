...
bycatchB <- bycatch_diff %>%
  ...
  scale_y_continuous(limits = c(-50, 100), labels = c("-50%", "0%", "50%", "100%"), breaks = c(-50, 0, 50, 100), expand = c(0,0))
...
ggsave("pdf_outputs/Revised_colony_bycatch_diff_plot_2panel.png", width = 7, height = 6.5)
```
